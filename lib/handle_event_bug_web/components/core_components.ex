defmodule HandleEventBugWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(HandleEventBugWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(HandleEventBugWeb.Gettext, "errors", msg, opts)
    # end
